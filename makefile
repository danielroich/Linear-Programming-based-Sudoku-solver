CC = gcc
OBJS = main.o sudoku_board.o backtracking_core_logic.o sudoku_board_actions.o puzzle_generator.o 2d_array_utils.o parser.o backtrack_core.o files_utils.o LP.o moves_list.o stack_backtrack_logic.o stack.o
EXEC = sudoku
...
sudoku_board.o: sudoku_board.c sudoku_board.h 2d_array_utils.h
	$(CC) $(COMP_FLAG) -c $*.c
files_utils.o: files_utils.c files_utils.h sudoku_board.h backtrack_core.h
	$(CC) $(COMP_FLAG) -c $*.c
...
moves_list.o: moves_list.c moves_list.h sudoku_board.h
	$(CC) $(COMP_FLAG) -c $*.c
