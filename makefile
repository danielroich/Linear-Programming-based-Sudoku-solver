CC = gcc
OBJS = main.o backtracking_core_logic.o sudoku_board.o sudoku_board_actions.o puzzle_generator.o 2d_array_utils.o parser.o backtrack_core.o file_utils.o LP.o moves_list.0 stack_backtrack_logic.o stack.o
EXEC = sudoku
